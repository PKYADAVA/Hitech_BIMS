...
from .views import (
    ...
    ChickSaleAPI,
    ChickSaleReceiptListTemplateView,
    ChickSaleReceiptFormTemplateView,
    ChickSaleReceiptAPI,
    chick_sale_receipt_balance_lookup,
...
urlpatterns = [
    ...
    path('chick-sale-receipt/', ChickSaleReceiptListTemplateView.as_view(), name='chick_sale_receipt_list'),
    path('chick-sale-receipt/add/', ChickSaleReceiptFormTemplateView.as_view(), name='chick_sale_receipt_add'),
    path('chick-sale-receipt/<int:id>/edit/', ChickSaleReceiptFormTemplateView.as_view(), name='chick_sale_receipt_edit'),
    path('chick_sale_receipt_api/', ChickSaleReceiptAPI.as_view(), name='chick_sale_receipt_api_list'),
    path('chick_sale_receipt_api/<int:id>/', ChickSaleReceiptAPI.as_view(), name='chick_sale_receipt_api'),
    path('chick-sale-receipt/balance-lookup/', chick_sale_receipt_balance_lookup, name='chick_sale_receipt_balance_lookup'),
