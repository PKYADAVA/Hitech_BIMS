...
from .views import BranchAPI, BranchTemplateView, BroilerBatchAPI, BroilerBatchFormTemplateView, BroilerBatchTemplateView, BroilerDiseaseAPI, BroilerDiseaseTemplateView, BroilerFarmAPI, BroilerFarmShedAPI, BroilerFarmShedTemplateView, BroilerFarmTemplateView, BroilerLineAPI, BroilerLineTemplateView, FarmerAPI, FarmerGroupAPI, FarmerGroupTemplateView, RegionAPI, RegionTemplateView, SupervisorAPI, SupervisorTemplateView
...
urlpatterns = [
    ...
    path('broiler-batch/add/', BroilerBatchFormTemplateView.as_view(),
         name='broiler_batch_add'),  # The add form, on its own page
    path('broiler_batch_list/', BroilerBatchAPI.as_view(), name='broiler_batch_list'),  # For listing all broiler batch
    path('create-batch/', BroilerBatchAPI.as_view(), name='broiler_batch_create'),
    path('create-batches/', views.broiler_batches_create,
         name='broiler_batches_create'),  # Several flocks in one save  # For creating new broiler batch
    ...
    path('broiler_batch/farm/<int:farm_id>/open/', views.farm_open_batches,
         name='farm_open_batches'),  # What is already running on a farm
    ...
    path('bird-sale/<int:id>/request-edit/', views.BirdSaleFormTemplateView.as_view(),
         {'request_mode': True}, name='bird_sale_request_change'),
    ...
    path('bird-sale-receipt/<int:id>/request-edit/', views.BirdSaleReceiptFormTemplateView.as_view(),
         {'request_mode': True}, name='bird_sale_receipt_request_change'),
    ...
    path('production-cost-report/', views.production_cost_report,
         name='production_cost_report'),
    ...
    path('farmer-farm-setup-request/', views.FarmerFarmSetupRequestListTemplateView.as_view(),
         name='farmer_farm_setup_request_list'),
    path('farmer-farm-setup-request/add/', views.FarmerFarmSetupRequestFormTemplateView.as_view(),
         name='farmer_farm_setup_request_add'),
    path('farmer-farm-setup-request/<int:id>/edit/', views.FarmerFarmSetupRequestFormTemplateView.as_view(),
         name='farmer_farm_setup_request_edit'),
    path('farmer-farm-setup-request-api/', views.FarmerFarmSetupRequestAPI.as_view(),
         name='farmer_farm_setup_request_api'),
    path('farmer-farm-setup-request-api/<int:id>/', views.FarmerFarmSetupRequestAPI.as_view(),
         name='farmer_farm_setup_request_api_detail'),
    path('farmer-farm-setup-request/<int:id>/approve/', views.farmer_farm_setup_request_approve,
         name='farmer_farm_setup_request_approve'),
    path('farmer-farm-setup-request/<int:id>/reject/', views.farmer_farm_setup_request_reject,
         name='farmer_farm_setup_request_reject'),
    ...
    path('farm-location-capture/<int:id>/request-edit/', views.farm_location_capture_edit,
         {'request_mode': True}, name='farm_location_capture_request_change'),
