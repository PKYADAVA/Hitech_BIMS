...
urlpatterns = [
    ...
    path('cost_center_master/<int:id>/toggle-lock/', views.cost_center_toggle_lock, name='cost_center_toggle_lock'),
    path('cost_center_master/<int:id>/approve/', views.cost_center_approve, name='cost_center_approve'),
    path('cost_center_master/tree/', views.cost_center_tree, name='cost_center_tree'),
    path('cost_center_master/<int:id>/children/', views.cost_center_children, name='cost_center_children'),
    path('cost_center_master/<int:id>/parent/', views.cost_center_parent, name='cost_center_parent'),
    path('cost_center_master/export/excel/', views.cost_center_export_excel, name='cost_center_export_excel'),
